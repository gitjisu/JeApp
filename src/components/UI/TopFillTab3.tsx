...
const TopFillTab3 = forwardRef<TopFillTab3Ref, Props>((props, ref) => {
  ...
  useImperativeHandle(
    ...
    [handlePressCenter, handlePressLeft, handlePressRight],
  );
